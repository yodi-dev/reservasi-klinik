...
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="reservation">Reservation</a>
                </li>
        ...
        <div class="heroe">
            ...
            <h1>Welcome to Web For Reservation</h1>

            <h2>Klinik Sehat lagi</h2>
    ...
    <footer>
        <div class="copyrights">
            ...
            <p>&copy; <?= date('Y') ?> made with love by AwanBeo-dev</p>
